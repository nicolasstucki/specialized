...
object SpecializedBenchmarkSameVM
   ...
   for (n <- Seq(10000000 /*200000, 500000, 1000000, 2000000*/ )) {
      ...
      bench(Gen.single("TestFunctionApplyNTimesRec[Int]")(n).map(new TestFunctionApplyNTimesRec[Int](_)(7, (x: Int) => x + 42)))
//      bench(Gen.single("TestFunctionApplyNTimesRec[Double]")(n).map(new TestFunctionApplyNTimesRec[Double](_)(2.3, (x: Double) => x + 42)))
